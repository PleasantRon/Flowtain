...
export function TimerPanel({
  ...
  const primaryLabel = isRunning ? "Stop" : mode === "work" ? "Start focus" : "Start break";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div key={phaseMotionKey} className={`${styles.phaseMotion} flex-1`}>
          ...
          {mode === "work" && (
            <label className="mt-4 block max-w-sm">
              ...
              <select
                ...
                className="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 outline-none transition focus:border-brand-400 focus:bg-white dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
              >
